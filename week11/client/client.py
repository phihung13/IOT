...
def create_query(device_name: str, tem: int, humi: int, led1: bool, led2: bool, time: datetime):
    param ={
        "device_name": device_name,
        "temp": tem,
        "humi": humi,
...
def get_method(query_string):
    ...
    print(query)
    url = "http://127.0.0.1:8000/api/items/?" + query
...
while True:
    ...
    query_string = create_query(device_name, tem, humi, led1, led2, time)
